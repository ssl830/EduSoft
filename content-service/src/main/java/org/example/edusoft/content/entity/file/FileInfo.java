...
public class FileInfo implements Serializable {
    ...
    private org.example.edusoft.content.entity.file.FileType fileType;      // 文件类型
    ...
    public org.example.edusoft.content.entity.file.FileType getFileType() { return fileType; }
