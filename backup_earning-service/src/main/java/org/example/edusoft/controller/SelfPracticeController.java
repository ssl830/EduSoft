...
import org.example.edusoft.learning.service.AiAssistantService;
...
public class SelfPracticeController {
    ...
    public Result<Map<String, Object>> submitPractice(@RequestBody Map<String, Object> req) {
        ...
        for (Map<String, Object> ans : answers) {
            ...
            org.example.edusoft.learning.entity.Question q = null;
            try {
                if (qid != 0) {
            ...
            org.example.edusoft.learning.entity.Question.QuestionType qType;
            try {
                qType = org.example.edusoft.learning.entity.Question.QuestionType.valueOf(qTypeStr);
            } catch (IllegalArgumentException e) {
                qType = org.example.edusoft.learning.entity.Question.QuestionType.singlechoice;
            }
