package org.example.edusoft.learning.controller.chat;

import lombok.extern.slf4j.Slf4j;
import org.example.edusoft.learning.service.chat.ChatManagementService;
...
@Slf4j
@RestController
@RequestMapping("/api/learning/chat")
public class ChatController {
    ...
    public Map<String, Object> getSessionDetail(@PathVariable Long sessionId) {
        try {
            Map<String, Object> sessionDetail = chatManagementService.getSessionDetail(sessionId);
            return Map.of(
                "code", 200,
                "message", "success",
                "data", sessionDetail
