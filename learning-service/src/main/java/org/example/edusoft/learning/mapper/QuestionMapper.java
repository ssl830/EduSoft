...
public interface QuestionMapper {
    ...
    @Insert("INSERT INTO practice_question (practice_id, question_id, score) VALUES (#{practiceId}, #{questionId}, #{score})")
    void addQuestionToPractice(@Param("practiceId") Long practiceId,
                             @Param("questionId") Long questionId,
                             @Param("score") Integer score);

    @Delete("DELETE FROM practice_question WHERE practice_id = #{practiceId} AND question_id = #{questionId}")
    void removeQuestionFromPractice(@Param("practiceId") Long practiceId, @Param("questionId") Long questionId);

    @Delete("DELETE FROM practice_question WHERE practice_id = #{practiceId}")
